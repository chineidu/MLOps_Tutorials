...
export function logWarn(
	...
	// V2 removed the `app.log` endpoint, so only use it when the client
	// actually provides it (e.g. a V1 client passed by an older caller).
	const app = (client as unknown as { app?: unknown }).app as
